...
<body>
  <div class="page">
    <div class="card">
      ...
      <div class="layout">
        <aside class="sidebar">
          <div class="sectionTitle filtersTitle">Φίλτρα</div>
          <div class="filters">
          ...
          <div class="sectionTitle addTitle">Προσθήκη νέας εργασίας</div>
          <div class="addForm">
        ...
        <section class="tasksPane">
          <div class="sectionTitle tasksTitle">Εργασίες</div>
